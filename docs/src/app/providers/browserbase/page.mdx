...
Eidos services inject the key through systemd
`LoadCredentialEncrypted=`. The lifecycle output contains only a redacted
session identifier, status, and safe human live-view URL.
